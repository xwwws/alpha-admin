export default {
  ...
  'menu.account.users.list': '用户列表',
  'menu.account.users.create': '创建新用户',
  'menu.account.users.edit': '编辑用户信息',
  ...
  'menu.account.menus.edit': '编辑菜单',
  'menu.account.menus.assignPermissions': '分配权限',
  'menu.device': '设备信息',
