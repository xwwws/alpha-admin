...
const DetailPipette: React.FC<IProps> = (props) => {
  ...
  const descriptionInfo: DescriptionsProps[`items`] = [
    ...
    { key: '13', label: '吸液吐液速度', children:  `${ record.kwargs.speed }ul/s` },
    { key: '10', label: '枪头长度', children:  `${ record.kwargs.tip_length } mm` },
    { key: '11', label: '高度', children:  `${ record.kwargs.height } mm` },
    { key: '12', label: '移液总量', children:  `${ record.kwargs.total } ul` },
    { key: '13', label: '单次吸液量', children:  `${ record.kwargs.take_once } ul` },
    { key: '13', label: '单次吐液量', children:  `${ record.kwargs.spit_once } ul` },
    { key: '13', label: '吐液间隔时长', children:  `${ record.kwargs.spit_once } s` },
  ];
  return (
    <>
      <Descriptions
